...
echo "* configs.."
rsync -ahzc "${HOME}/.dotfoles-cdly/zsh/.p10k.zsh" "${HOME}/" || exit 100
rsync -ahzc "${HOME}/.dotfoles-cdly/zsh/.zshrc" "${HOME}/" || exit 100
rsync -ahzc "${HOME}/.dotfoles-cdly/dotfiles/.nanorc" "${HOME}/" || exit 100
sudo rsync -ahzc "${HOME}/.dotfoles-cdly/zsh/.p10k.zsh" "/root/" || exit 100
sudo rsync -ahzc "${HOME}/.dotfoles-cdly/zsh/.zshrc" "/root/" || exit 100
sudo rsync -ahzc "${HOME}/.dotfoles-cdly/dotfiles/.nanorc" "/root/" || exit 100
mkdir -p "${HOME}/.config/neofetch/" || exit 100
sudo mkdir -p "/root/.config/neofetch/" || exit 100
rsync -ahzc "${HOME}/.dotfoles-cdly/dotfiles/neofetch.conf" "${HOME}/.config/neofetch/config.conf" || exit 100
sudo rsync -ahzc "${HOME}/.dotfoles-cdly/dotfiles/neofetch.conf" "/root/.config/neofetch/config.conf" || exit 100
...
case $architecture in
    ...
    *)     sudo bash "${HOME}/.dotfoles-cdly/github/dpkg-github.sh" -a "$(dpkg --print-architecture)" -i Peltoche/lsd
esac
...
[[ -f "${HOME}/.dotfoles-cdly/mods/update.sh" ]] && source "${HOME}/.dotfoles-cdly/mods/update.sh"
